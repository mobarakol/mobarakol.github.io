...
<div style="border:1px solid #e5e7eb; border-left:6px solid #ef4444; border-radius:12px; padding:16px 18px; background:#fafafa;">
  ...
  <ol style="margin:0; padding-left:22px; line-height:1.5;">
    <li>
      President’s Doctoral Scholarship PhD (Deadline: Monday, March 16, 2026):
      <a href="https://www.findaphd.com/phds/project/president-s-doctoral-scholar-award-multimodal-llm-based-reasoning-over-environmental-exposure-and-respiratory-disease-severity/?p194324" target="_blank" rel="noopener">
...
<div style="border:1px solid #e5e7eb; border-left:6px solid #ef4444; border-radius:12px; padding:16px 18px; background:#fafafa;">
  ...
  <h2 style="margin:0 0 10px 0; font-size:24px; text-align:center;">
    <span style="color:black">Self-funded Openings</span>
  </h2>

  <ol style="margin:0; padding-left:22px; line-height:1.5;">
    <li>
      Self-funded Project-1 (No deadline):
      <a href="https://www.findaphd.com/phds/project/multimodal-llm-agents-for-early-detection-of-brain-tumour-recurrence/?p186847" target="_blank" rel="noopener">
...
<!-- <div style="border:1px solid #e5e7eb; border-left:6px solid #ef4444; border-radius:12px; padding:16px 18px; background:#fafafa;">
  ...
  <ol style="margin:0; padding-left:22px; line-height:1.5;">
    ...
    <li>
      ...
      <a href="https://www.bmh.manchester.ac.uk/study/research/funding-fees/funded-programmes/csc-scholarship/" target="_blank" rel="noopener">
...
# Previous Openings [Deadline Passed]

1. MRC DTP Studentship/Scholarship (Deadline: Saturday, November 08, 2025): <a href="https://www.findaphd.com/phds/project/bicentenary-interactive-vision-language-foundation-models-for-decision-support-in-pathological-stratification-of-appendix-cancers/?p187373" target="_blank" rel="noopener"> Early Detection of Prostate Cancer Progression with Longitudinal Multimodal LLM Agents</a>

2. Bicentenary Studentship/Scholarship (Deadline: Saturday, November 15, 2025): <a href="https://www.findaphd.com/phds/project/surgical-ai-copilot-multimodal-llm-agent-in-minimally-invasive-surgery/?p186856" target="_blank" rel="noopener"> Interactive Vision-Language Foundation Models for Decision Support in Pathological Stratification of Appendix Cancers</a>
